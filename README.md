# About
A lightweight library for retrieving the most recent error code and its corresponding error message, intended exclusively for use with P/Invoke or function pointers.
