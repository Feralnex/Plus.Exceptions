# About
A lightweight C# interop library for retrieving the latest error code and message. It leverages the Plus library, which provides easy macros and unified types.
